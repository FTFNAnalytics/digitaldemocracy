...
6. **Do not** implement a LatAm/NZ importer in this Batch B change. **Do not** approve the remaining 10 residual-heavy packs here. **Do not** modify frozen research bytes.
