...
| Denmark | Prompt X research + approved tiers | Justin accepted **106 current + 240 historical** offices on 2026-09-19. Research at `data/research/denmark/`; approved `schemas/atlas/tiers/denmark.json` (324 municipal / 20 regional / 1 national / 1 other). Greenland/Faroe Realm coverage gates, 2007/earlier merger successor bindings, KMD/DST detail holes, 98 unresolved candidate bindings, and EP detail gaps stay open. No popular mayor rows (council-elected borgmester). Do not invent Greenland/Faroe offices or fabricate merger clearances. Atlas importer waits. Slim pack omitted bulky sources; do not invent those bytes. No `/electiondatabase` redirects. |
