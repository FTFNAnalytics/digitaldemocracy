...
| Serbia | Prompt AX REBUILT docs + accepted-with-holds tiers | Justin accepted **173 current + 5 historical-only** offices on 2026-09-25 (America/Edmonton) with holds RS-AX-G01–RS-AX-G11 left open, including the Kosovo scope gate (RS-AX-G05). Docs at `docs/phase1/serbia/`; supplied `schemas/atlas/tiers/serbia.json` (2 national / 1 regional / 175 municipal; 178 rows 1:1; every `justin_approved` stays false). Kosovo-scope offices stay 0. Direct local executives stay 0. European Parliament offices stay 0. Events 531 / results 671 are in the pack; 520 local result-state rows stay null / `not_transcribed`. Five crosswalk rows are sourced same-territory status changes, not merger edges. `research_coverage_complete` stays false. Full ZIP SHA-256 `f3d10fdacac987acd10d82af364478510ac302db120084186909a420a518c864`. Atlas importer waits. This land is docs and tiers only. Do not set `ATLAS_IMPORT_SCOPE`. Do not invent Kosovo-scope offices, local numeric vectors, direct local executives, EP offices, or extra successor edges. No `/electiondatabase` redirects. |
...
| Montenegro | Prompt AY docs + accepted-with-holds draft tiers | Justin accepted **27 current + 2 historical-only** offices (29) on 2026-09-25 (America/Edmonton) with holds ME-AY-G01–ME-AY-G11 left open. Docs at `docs/phase1/montenegro/`; supplied draft `schemas/atlas/tiers/montenegro.json` (2 national / 27 municipal; 29 rows 1:1; every `justin_approved` false). `research_coverage_complete` stays false. Current: Parliament + President + 25 local assemblies. Historical-only nested assemblies: Golubovci and Tuzi-within-Podgorica. Events 71 (6 parliamentary + 5 presidential + 60 local). Result rows 153. Direct executives 1 (President). Direct local executives 0. EP offices 0. Both territorial relations keep `successor_office_id` null. ZIP SHA-256 `23f658bd392ce13c3d450f4fa383acae7a1e94c9c78829c666027c31e2e487f2`. Atlas importer waits. This land is docs and draft tiers only. Do not set `ATLAS_IMPORT_SCOPE`. Do not invent local numeric vectors, a Šavnik 2022 final result, older local contests, successor edges, a state-union federal office, a 2016 parliamentary list vector, an EP office, a prospective local election, or a two-vote correction to the 2006 return. No `/electiondatabase` redirects. |
| North Macedonia | Prompt AZ docs + accepted-with-holds draft tiers | Justin accepted **164 current + 8 historical-only** offices (172) on 2026-09-25 (America/Edmonton) with holds MK-AZ-G01, MK-AZ-G04, MK-AZ-G05, MK-AZ-G09, MK-AZ-G10, MK-AZ-G11, MK-AZ-G12, MK-AZ-G14, MK-AZ-G15, MK-AZ-G16, MK-AZ-G17, MK-AZ-G19, MK-AZ-G20, MK-AZ-G21, MK-AZ-G22, and MK-AZ-G23 left open. Pack-resolved MK-AZ-G02, MK-AZ-G03, MK-AZ-G06, MK-AZ-G07, MK-AZ-G08, MK-AZ-G13, and MK-AZ-G18 stay as recorded and are not reopened. Docs at `docs/phase1/north-macedonia/`; supplied draft `schemas/atlas/tiers/north-macedonia.json` (2 national / 170 municipal; 172 rows 1:1; every `justin_approved` false). `research_coverage_complete` stays false. Current: Parliament + popular President + 81 councils + 81 popular mayors. Current direct executives 82. Historical-only: 4 councils + 4 mayors (Drugovo, Vraneshtica, Zajas, Oslomej). EP 0. Regional 0. Full pack 813 events / 1700 results, omitted from this slim land. `office_successor_edges` stays empty. The 2013 Kichevo territorial claim is not an office identity. Full ZIP SHA-256 `0ecd5c5254246cbfd00981c03ff642c6136736c6d45b1a61d563223ef0370a4d`. Atlas importer waits. This land is docs and draft tiers only. Do not add North Macedonia to `ATLAS_IMPORT_SCOPE`. Do not invent omitted `sources/`, `events.jsonl`, or `results.jsonl` bytes, offices, votes, or successor edges. No `/electiondatabase` redirects. |
