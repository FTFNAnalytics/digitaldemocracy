...
| `npm run import:atlas` | `scripts/atlas/import.ts` — Albania Phase 1 importer plus Andorra / Alderney / Armenia / Belgium / Bosnia and Herzegovina / Bulgaria / Switzerland and approved LatAm/NZ continuity (`ATLAS_IMPORT_SCOPE`) |
