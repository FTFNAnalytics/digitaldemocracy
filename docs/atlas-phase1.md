...
| Latvia Prompt AG field map | [docs/phase1/latvia/](phase1/latvia/Prompt_AG_Full_Register_Field_Map_and_CI.md) — mapping **Done**; importer CI **Not run** (research at `data/research/latvia/`; **45 current + 121 historical accepted with holds**; Atlas importer waits) |
| Hungary Prompt AK field map | [docs/phase1/hungary/](phase1/hungary/Prompt_AK_Full_Register_Field_Map_and_CI.md) — mapping **Done**; importer CI **Not run** (research at `data/research/hungary/`; **6,378 current + 0 historical accepted with holds**; Atlas importer waits) |
| Romania Prompt AL field map | [docs/phase1/romania/](phase1/romania/Prompt_AL_Full_Register_Field_Map_and_CI.md) — mapping **Done**; importer CI **Not run** (research at `data/research/romania/`; **6,460 current + 0 historical accepted with holds**; Atlas importer waits) |
...
| Malta Prompt AP field map | [docs/phase1/malta/](phase1/malta/Prompt_AP_Full_Register_Field_Map_and_CI.md) — mapping **Done**; importer CI **Not run** (research at `data/research/malta/`; **213 current + 2 historical accepted with holds**; Atlas importer waits) |
| Lithuania Prompt AH field map | [docs/phase1/lithuania/](phase1/lithuania/Prompt_AH_Full_Register_Field_Map_and_CI.md) — mapping **Done**; importer CI **Not run** (research at `data/research/lithuania/`; **123 current + 0 historical accepted with holds**; draft tiers landed 1:1; Atlas importer waits) |
...
| Germany Prompt AS field map | [docs/phase1/germany/](phase1/germany/Prompt_AS_Full_Register_Field_Map_and_CI.md) — mapping **Done**; importer CI **Not run** (docs and tiers only; **21,960 current + 670 historical accepted with holds**; DE-G01–DE-G23 open; `research_coverage_complete` stays false; Atlas importer waits) |
| United Kingdom Prompt AU field map | [docs/phase1/united-kingdom/](phase1/united-kingdom/FIELD_MAP_223.md) — mapping **Done**; importer CI **Not run** (docs and tiers only; **482 current + 2 shadow + 26 historical-only accepted with holds**; G01–G27 open; `research_coverage_complete` stays false; Atlas importer waits) |
| Italy Prompt AT field map | [docs/phase1/italy/](phase1/italy/README.md) — mapping **Done**; importer CI **Not run** (docs and tiers only; **15,917 current + 696 historical + 8 pending FVG accepted with holds**; IT-G01–IT-G19 open; `research_coverage_complete` stays false; Atlas importer waits) |
...
tables land at `data/research/latvia/`; Atlas importer waits. Slim pack
...
(mapping Done; execution CI Not run). Justin accepted **6,378 current + 0
...
Research tables land at `data/research/hungary/`; Atlas importer waits.
Slim pack omitted bulky sources, `results.json`, and identity vectors.
Do not invent omitted bytes.

Romania Prompt AL docs are in
[docs/phase1/romania/](phase1/romania/README.md)
(mapping Done; execution CI Not run). Justin accepted **6,460 current + 0
historical** offices on 2026-09-22 with named holds. Standing policy
retains offices and historic rows outside the ~18-month alert window. HOLD:
...
Research tables land at `data/research/romania/`; Atlas importer waits.
`events.json` is `events.json.gz` only.
...
`data/research/cyprus/`; Atlas importer waits. Slim land omitted
`sources/` and `results.json`. Do not invent omitted bytes.

Malta Prompt AP docs are in
[docs/phase1/malta/](phase1/malta/README.md)
(mapping Done; execution CI Not run). Justin accepted **213 current + 2
historical** offices on 2026-09-22 with named holds. Standing policy
retains offices and historic rows outside the ~18-month alert window. HOLD:
...
`data/research/malta/`; Atlas importer waits. Slim land omitted
`sources/`, `results.json`, and `stv-counts.json`. Do not invent omitted
bytes.
...
Research tables land at `data/research/france/`; Atlas importer waits.
Slim pack omitted `sources/`, `results.jsonl`, `events.jsonl`, and
`reporting-units.jsonl`.

Luxembourg Prompt AO docs are in
[docs/phase1/luxembourg/](phase1/luxembourg/README.md)
(mapping Done; execution CI Not run). Justin accepted **102 current + 28
historical** offices on 2026-09-22 with named holds. Standing policy
retains offices and historic rows outside the ~18-month alert window. HOLD:
...
tables land at `data/research/luxembourg/`; Atlas importer waits.
...
(mapping Done; execution CI Not run). Justin accepted **123 current + 0
historical** offices on 2026-09-22 with named holds. Standing policy
retains offices and historic rows outside the ~18-month alert window. HOLD:
...
Research tables land at `data/research/lithuania/`; Atlas importer waits.
Slim pack omitted raw `sources/` and `validate.py`.
...
(mapping Done; execution CI Not run). Justin accepted **21,960 current +
...
and are not remapped. The delivered direct-executive subset is 9,585.
...
is docs and tiers only. Do not invent omitted `sources/` or
`results.jsonl` bytes, missing SH mayors, subdivision rosters,
successor edges, or repaired seat panels. Atlas importer waits.

United Kingdom Prompt AU docs are in
[docs/phase1/united-kingdom/](phase1/united-kingdom/README.md)
(mapping Done; execution CI Not run). Justin accepted **482 current + 2
...
2 / 5 / 76 / 427 (T1 / T2 / T3 / T4; 510 rows 1:1) and are not remapped.
...
shadow authorities stay `current_shadow` (G15). This land is docs and
tiers only. Do not invent omitted `sources/`, `results.jsonl.gz`, or
`events.jsonl` bytes, a parish universe, a post-Brexit EP office, Crown
...
(mapping Done; execution CI Not run). Justin accepted **15,917 current +
...
(IT-G13). This land is docs and tiers only. Do not invent circoscrizioni,
Delrio popular provinces, FVG election dates, runoff rows, repaired
Bolzano arithmetic, or guessed successor edges. Atlas importer waits.
...
| Latvia Prompt AG field map | **Documentation complete** in [docs/phase1/latvia/](phase1/latvia/README.md). Mapping Done; importer CI Not run. Research at `data/research/latvia/`. `latvia.json` is 45 current + 121 historical accepted with holds (163 municipal / 0 regional / 2 national / 1 other). Identity vectors and raw sources omitted from the slim land. Historical 121 rows are identity records, not abolished councils. |
| Hungary Prompt AK field map | **Documentation complete** in [docs/phase1/hungary/](phase1/hungary/README.md). Mapping Done; importer CI Not run. Research at `data/research/hungary/`. `hungary.json` is 6,378 current + 0 historical accepted with holds (6,355 municipal / 20 regional / 2 national / 1 other). Results, identity vectors, and raw sources omitted from the slim land. |
| Romania Prompt AL field map | **Documentation complete** in [docs/phase1/romania/](phase1/romania/README.md). Mapping Done; importer CI Not run. Research at `data/research/romania/`. `romania.json` is 6,460 current + 0 historical accepted with holds (6,372 municipal / 84 regional / 3 national / 1 other). 23 national/EP result rows retained; local vectors absent. |
...
| Malta Prompt AP field map | **Documentation complete** in [docs/phase1/malta/](phase1/malta/README.md). Mapping Done; importer CI Not run. Research at `data/research/malta/`. `malta.json` is 213 current + 2 historical accepted with holds (204 municipal / 8 regional / 2 national / 1 other). `stv-counts.json`, `results.json`, and raw sources omitted from the slim land. |
| Lithuania Prompt AH field map | **Documentation complete** in [docs/phase1/lithuania/](phase1/lithuania/README.md). Mapping Done; importer CI Not run. Research at `data/research/lithuania/`. `lithuania.json` is 123 current + 0 historical accepted with holds (120 municipal / 0 regional / 2 national / 1 other). Draft tiers landed 1:1. Raw sources omitted from the slim land. |
...
| Germany Prompt AS field map | **Documentation complete** in [docs/phase1/germany/](phase1/germany/README.md). Mapping Done; importer CI Not run. Docs and tiers only. `germany.json` is 21,960 current + 670 historical accepted with holds (jurisdiction tiers 1/2/3/4 = 3 / 20 / 552 / 22,055). DE-G01–DE-G23 stay open. `research_coverage_complete` stays false. Bulky research dumps omitted from the slim land. |
| United Kingdom Prompt AU field map | **Documentation complete** in [docs/phase1/united-kingdom/](phase1/united-kingdom/README.md). Mapping Done; importer CI Not run. Docs and tiers only. `united-kingdom.json` is 482 current + 2 shadow + 26 historical-only accepted with holds (draft tiers T1/T2/T3/T4 = 2 / 5 / 76 / 427; 510 rows 1:1). G01–G27 stay open. `research_coverage_complete` stays false. Bulky research dumps omitted from the slim land. |
| Italy Prompt AT field map | **Documentation complete** in [docs/phase1/italy/](phase1/italy/README.md). Mapping Done; importer CI Not run. Docs and tiers only. `italy.json` is 15,917 current + 696 historical + 8 pending FVG accepted with holds (jurisdiction tiers 1/2/3/4 = 4 / 38 / 11 / 16,568; 16,621 rows 1:1). IT-G01–IT-G19 stay open. `research_coverage_complete` stays false. File `Justin_accepted` stays false. Bulky research dumps omitted from the slim land. |
