...
| Austria Prompt N field map | [docs/phase1/austria/](phase1/austria/Prompt_N_Tiers_Field_Map_and_CI.md) — mapping **Done**; importer CI **Not run** (package not on main) |
...
package is not on main; the importer waits. Publication hold
...
| Austria Prompt N field map | **Documentation complete** in [docs/phase1/austria/](phase1/austria/README.md). Mapping Done; importer CI Not run. Package not on main. Approved `austria.json` is 2,034 municipal / 4 regional. |
