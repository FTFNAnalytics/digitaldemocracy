...
| Bosnia Prompt O field map | [docs/phase1/bosnia-and-herzegovina/](phase1/bosnia-and-herzegovina/Prompt_O_Tiers_Field_Map_and_CI.md) — mapping **Done**; importer CI **Not run** (package PR #15 not on main; docs + approved tiers only) |
...
regional). Package PR #15 is not on main. Open RS presidential replacement/repeat,
governing coalition, and 2026-10-04 calendar-certainty notes remain; do not invent
Brčko or municipal offices.
...
| Bosnia Prompt O field map | **Documentation complete** in [docs/phase1/bosnia-and-herzegovina/](phase1/bosnia-and-herzegovina/README.md). Mapping Done; importer CI Not run. Package PR #15 not on main. Approved `bosnia-and-herzegovina.json` is all 13 regional. |
