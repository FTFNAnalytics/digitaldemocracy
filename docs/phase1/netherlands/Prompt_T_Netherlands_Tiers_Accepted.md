...
| --- | ---: | --- | --- |
| **Accepted current** | **432** | 342 municipal councils + 12 provincial states + 21 waterboard boards + national chambers/EP + islands/colleges + Amsterdam/Rotterdam submunicipal bodies (`human_review_required` as drafted) | Not in this landing — no importer |
| **Accepted historical** | **69** | historic municipal-council identities retained outside the alert window | Not in this landing — no importer |
...
Importer / SQLite / VPS / UI remain follow-up work. `import:atlas` is **not** implemented for Netherlands in this landing. No `/electiondatabase` redirects and no Mexico edits.
