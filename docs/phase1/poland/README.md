# Poland full register — Prompt AC / APPROVED

**5,310 current + 2 historical offices; 16,767 events; 641,493 result rows (review extract).** Draft tiers: 4,960 municipal, 330 regional, 3 national, 19 other. Main pin `785bae49b4b3ac6bc2ef105f33cc826caa948caf`. Research capture 2026-09-20.

Start: docs/phase1/poland/Poland_Full_Register_Report.md. Data: data/research/poland/. Tiers: schemas/atlas/tiers/poland.json (**approved**, production_accepted). Sejm, Senat, presidency, EP delegation, 16 sejmiks, 314 powiat councils, 2,479 municipal councils and matching direct executives retained. Historic Ostrowice retained; no guessed merger edges. PL-POWIAT-TIER left open (16 sejmiks + 314 powiat drafted regional — do not reclassify).
