# Croatia full-register handoff — Prompt W (DRAFT)
...
- [ ] Justin accepts register scope and named holds.
- [ ] Justin accepts draft tiers, including Zagreb and EP.
- [ ] Justin accepts historic identities and projection policy.
