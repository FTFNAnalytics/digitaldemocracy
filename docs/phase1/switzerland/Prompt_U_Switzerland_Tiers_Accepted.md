...
| --- | ---: | --- | --- |
| **Accepted current** | **2,805** | federal chambers + 26 cantonal legislatures + 26 cantonal executives + communal executives/presidents/legislatures as drafted (`human_review_required` retained where flagged) | Not in this landing — no importer |
| **Accepted historical** | **11** | sourced historic communal identities retained outside the alert window | Not in this landing — no importer |
...
Importer / SQLite / VPS / UI remain follow-up work. `import:atlas` is **not** implemented for Switzerland in this landing. No `/electiondatabase` redirects and no Mexico edits.
