...
Albania municipal and Alderney `other` are **`approved`**. Andorra is **`approved`** (Justin 2026-09-16; 7 communal councils). Armenia is **`approved`** (Prompt L 2026-09-17; 71 municipal / 0 regional). Five Armenia boundary/calendar research reviews remain open separately from geographic-tier approval. Austria is **`approved`** (Prompt N 2026-09-17; 2,034 municipal / 4 regional). The Austria package is on main (PR #11, `f0f2c86`); the Atlas importer waits. The St. Georgen am Walde 2015 publication hold and open calendar/boundary research notes remain. Bosnia and Herzegovina is **`approved`** (Prompt O 2026-09-17; **all 13 regional**). Package PR #15 is not on main; this file is docs + geographic-tier approval only. Open RS presidential / coalition / calendar-certainty notes remain; do not invent Brčko or municipal offices.
...
| [`bosnia-and-herzegovina.json`](bosnia-and-herzegovina.json) | 13 | `regional` (13) | **Approved** 2026-09-17 (Justin / Prompt O). Package PR #15 not on main. Open RS presidential / coalition / calendar notes retained |
...
2026-10-04). Package PR #15 is not on main; Atlas importer CI waits.
