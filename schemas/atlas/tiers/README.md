...
labels come from the Prompt E pack; they are not invented here. Andorra, Alderney, Armenia, Austria, Bosnia and Herzegovina, Bulgaria, Belgium, Netherlands, Switzerland, Denmark, Sweden, Finland, Norway, Ireland, Poland, Czechia, Croatia, Portugal, Spain, Estonia, Latvia, Hungary, Romania, Greece, Luxembourg, France, Cyprus, Malta, Lithuania, Slovakia, Slovenia, Germany, the United Kingdom, and Italy files above are unchanged. Albania `albania.json` is the Prompt BA draft described above; the Phase 1 approved bytes are preserved beside it.
