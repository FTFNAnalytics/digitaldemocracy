...
and `validate.py`. Do not invent omitted bytes or hold resolutions. The
Atlas importer waits.
...
Andorra, Alderney, Armenia, Austria, Bosnia and Herzegovina, Bulgaria, Belgium, Netherlands, Switzerland, Denmark, Sweden, Finland, Norway, Ireland, Poland, Czechia, Croatia, Portugal, Spain, Estonia, Latvia, Hungary, Romania, Greece, Luxembourg, France, Cyprus, Malta, Lithuania, Slovakia, Slovenia, and Germany files above are unchanged.
