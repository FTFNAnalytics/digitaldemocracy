...
export function atlasImportStatusMessage(
  ...
  return [
    ...
    "ATLAS_IMPORT_SCOPE=albania|andorra|alderney|armenia|austria|belgium|bosnia|bulgaria|croatia|czechia|denmark|estonia|latvia|lithuania|romania|greece|luxembourg|malta|cyprus|france|germany|united_kingdom|italy|iceland|montenegro|serbia|north_macedonia|hungary|finland|ireland|netherlands|norway|poland|portugal|spain|sweden|switzerland|latam|nz|all (default all). Draft residual-heavy packs are skipped.",
    ...
    "Montenegro is ATLAS_IMPORT_SCOPE=montenegro only. The default all scope does not import Montenegro.",
    "Serbia is ATLAS_IMPORT_SCOPE=serbia only. The default all scope does not import Serbia. Kosovo-scope offices stay 0.",
    "North Macedonia is ATLAS_IMPORT_SCOPE=north_macedonia only. The default all scope does not import North Macedonia.",
