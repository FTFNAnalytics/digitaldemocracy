...
export function atlasImportStatusMessage(
  ...
  return [
    ...
    "",
    "npm run import:atlas loads Albania, Andorra, Alderney, Armenia, Belgium, Bosnia and Herzegovina, and approved continuity packs into SQLite (atomic publish + durable attempt ledger).",
    "ATLAS_IMPORT_SCOPE=albania|andorra|alderney|armenia|belgium|bosnia|latam|nz|all (default all). Draft residual-heavy packs are skipped.",
