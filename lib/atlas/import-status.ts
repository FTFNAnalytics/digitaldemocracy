...
export function atlasImportStatusMessage(
  ...
  return [
    ...
    "",
    "npm run import:atlas loads Albania, Andorra, Alderney, Armenia, Austria, Belgium, Bosnia and Herzegovina, Bulgaria, Denmark, Netherlands, and approved continuity packs into SQLite (atomic publish + durable attempt ledger).",
    "ATLAS_IMPORT_SCOPE=albania|andorra|alderney|armenia|austria|belgium|bosnia|bulgaria|denmark|netherlands|latam|nz|all (default all). Draft residual-heavy packs are skipped.",
