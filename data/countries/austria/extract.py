...
COUNTRY = 'Austria'
CODE = 'AT'
COMPANION = 'Austria_Municipal_Elections.xlsx'
...
def main(archive_path):
    ...
    with zipfile.ZipFile(archive_path) as archive:
        ...
        name = "Office_Briefings/" + COUNTRY.lower() + ".html"
        ...
        compressed=lzma.compress(payload.getvalue(),preset=9)
        chunks={}
