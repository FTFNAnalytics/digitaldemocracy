# Belarus — European research import
...
**Source status:** No ordinary in-window cycle identified / special watch.
...
**Remaining gaps, as recorded in the source:** Election commission explicitly lists 25 February 2029 as next unified deputy election; no ordinary local election in window. Announced replacements have not been exhaustively enumerated.

**Screening source retained from the original research:** https://www.rec.gov.by/ru/election-schedule-ru
...
```sh
python data/countries/belarus/validate.py /tmp/belarus-research
```
...
```sh
python data/countries/belarus/extract.py /path/to/Europe_Excluding_Russia_Election_Data_2026-09-15.zip
```
