...
`results.json` is gunzipped from the slim pack’s `results.json.gz` (37,471 rows) so the file matches other Atlas country packages, which store uncompressed results. SHA-256 `b0ae52a59cf194bf33efe27d43fce2ff5497ec56b0f1a7c91fc637fee4b59097`. Do not treat the landing bytes as a new research extract.

See [docs/phase1/finland/README.md](../../../docs/phase1/finland/README.md).
