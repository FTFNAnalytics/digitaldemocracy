...
Core tables landed from the slim review pack. `SOURCES_NOTE.md` records bulky primary-source members omitted from this attach; do not invent those bytes.

`results.json` is 7,254 rows (~13MB uncompressed), matching the slim pack. SHA-256 of `office-register.json` is `329bfaadd79d41a5772e7b9070e7d67ef3e7810fd41dd0a22fdfda17b723f1cc`.

See [docs/phase1/ireland/README.md](../../../docs/phase1/ireland/README.md).
