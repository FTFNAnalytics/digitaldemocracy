...
describe("approved-pack gate", () => {
  ...
  it("parses ATLAS_IMPORT_SCOPE and rejects unknown values", () => {
    ...
    expect(parseImportScope("croatia")).toBe("croatia");
    expect(parseImportScope("czechia")).toBe("czechia");
    expect(parseImportScope("denmark")).toBe("denmark");
    expect(parseImportScope("estonia")).toBe("estonia");
    expect(parseImportScope("latvia")).toBe("latvia");
    expect(parseImportScope("lithuania")).toBe("lithuania");
    expect(parseImportScope("romania")).toBe("romania");
    expect(parseImportScope("greece")).toBe("greece");
    expect(parseImportScope("luxembourg")).toBe("luxembourg");
    expect(parseImportScope("malta")).toBe("malta");
    expect(parseImportScope("cyprus")).toBe("cyprus");
    expect(parseImportScope("france")).toBe("france");
    ...
    expect(parseImportScope("norway")).toBe("norway");
    expect(parseImportScope("poland")).toBe("poland");
    expect(parseImportScope("portugal")).toBe("portugal");
    expect(parseImportScope("spain")).toBe("spain");
